...
namespace M2M5_fin5_1.Controllers
{
    public class GradesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GradeID,GradeReceived,StudentID,AssignmentID")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GradeID,GradeReceived,StudentID,AssignmentID")] Grade grade)
        {
            if (ModelState.IsValid)
            {
